        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            Kuisioner Alumni ITS <small>Petunjuk pengisian form</small>
                        </h2>
                    </div>
                    <div class="body">
                        <p>Berikut ini adalah petunjuk pengisian <strong>Kuisioner <i>Tracer Study</i> &nbsp;ITS</strong></p>
                        <ol>
                            <li>Disarankan pengisian <strong>Kuisioner Alumni ITS</strong> menggunakan <strong>Komputer / Laptop</strong>.</li>
                        ...
                        <a href="<?php echo base_url().'review' ?>"><button style="float: right; display: none;" id="siap" name="siapisi" class="btn bg-green waves-effect">CONTINUE / REVIEW</button></a>
                    </div>
